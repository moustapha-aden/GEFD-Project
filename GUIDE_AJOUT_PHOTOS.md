...
Le dossier `public/images/docs/` a été créé pour stocker toutes vos images.
...
Une fois les images ajoutées, elles apparaîtront automatiquement dans la documentation !

## ⚠️ Important : Confidentialité

Pour les images contenant des informations personnelles :
- **Diplômes** : Masquez le nom, prénom, date de naissance
...
- Utilisez un outil comme **Snipping Tool** (Windows) ou **Screenshot** (Mac)
...
Les images sont déjà référencées dans les fichiers MDX avec la syntaxe :
```markdown
![Description de l'image](/images/docs/nom-fichier.jpg)
```

Il vous suffit d'ajouter les fichiers images dans le dossier `public/images/docs/` !
